...
export function DashboardWorkspace() {
  ...
  return (
    <section className="page dashboard-page">
      <div className="page-heading dashboard-heading"><div><p className="eyebrow">Workspace pulse</p><h1>{greeting}, {accountName}</h1><p className="page-subtitle">Here is what your conversations are moving forward.</p></div><div className="dashboard-heading-actions"><span className="workspace-live"><i />Workspace synced</span><Link className="button button-primary" href="/meetings">Review meetings<ArrowRight size={16} /></Link></div></div>
